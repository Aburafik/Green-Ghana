...
List<GetAllTreeModel> getAllTreeModelFromJson(String str) => List<GetAllTreeModel>.from(json.decode(str).map((x) => GetAllTreeModel.fromJson(x)));

String getAllTreeModelToJson(List<GetAllTreeModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GetAllTreeModel {
    ...
    factory GetAllTreeModel.fromJson(Map<String, dynamic> json) => GetAllTreeModel(
        id: json["_id"],
